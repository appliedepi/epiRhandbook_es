...
DT::datatable(head(followups, 50), rown# mostrar las 50 primeras filas de datos de la lista de contactos en forma de tablaames = FALSE, options = list(pageLength = 5, scrollX=T), class = 'white-space: nowrap' )
```
